  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between pl-8 pr-6 pb-8 pt-14 md:pl-16 md:pr-12 md:pb-14 md:pt-20 lg:pb-16 lg:pt-24">
        ...
        {/* Upper-left: quote */}
        <div>
          <h1 className="relative max-w-[260px] text-[1.5rem] font-bold leading-[1.15] tracking-[-0.03em] text-white sm:text-[1.75rem] md:text-[2.75rem] md:leading-[1.1] md:tracking-[-0.04em] md:max-w-[700px]">
            <span
...
export default function Why() {
  useEffect(() => { document.title = 'Why I Do It — Franck Hoffmann' }, [])
  return (
